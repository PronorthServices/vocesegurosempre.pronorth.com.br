...
<head>
    ...
    <title>Você Sempre Seguro - Landing Page</title>
    ...
    <link  href="css/voce_seguro.css"  rel="stylesheet">
</head>
<body id="page-top">
        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
            <div class="container">
                <div class="navbar-header page-scroll">
                    ...
                    <a class="navbar-brand logo col-lg-12" href="#"><img src="img/logo.jpg"></a>
                </div>
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav navbar-right menu">
                        ...
                        <!--<li><a class="page-scroll" href="#pricing">Promoções</a></li>-->
...
<div id="inSlider" class="carousel carousel-fade" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            ...
            <div class="header-back"><img src="img/slide001.jpg" alt=""></div>
        ...
        <div class="item">
            <div class="container">
             ...
             Set background for slide in css 
            <div class="header-back two img-responsive"></div>
        </div>
        <div class="item">
            <div class="container">
            </div>
            <div class="header-back tree img-responsive"></div>
        </div>
        -->
    </div>
    <!--
...
<section id="equipamentos"  class="container features">
    <div class="row">
        <div class="col-lg-12 text-center">
            <div class="navy-line"></div>
        ...
        <div class="row">
            ...
            <div class="col-sm-4 central">
                <div class="team-member wow zoomIn">
                    ...
                    <h4><span class="navy">Sobre</span> Nós</h4>
                    <p>Uma empresa que tem como pilar oferecer o serviço de monitoramento para sua residência e/ou empresa, além de produtos e equipamentos de segurança. Utilizamos produtos da alta qualidade e de ultima geração sempre com a preocupação de dar as soluções adequadas a cada etapa de um projeto personalizado de segurança com a prestação de serviço de monitoramento de alarmes e sistemas integrados de segurança.Tudo com alta performance, qualidade e tecnologia internacional.</p>
                </div>
            </div>
            <div class="col-sm-4 wow fadeInRight">
                <div class="team-member">
                    ...
                    <p> Projetar e fornecer soluções personalizadas e confiáveis de segurança;
                        Atender as necessidades de cada um dos nossos clientes;
                        Capacitar nossos colaboradores e manter a equipe sempre atualizada;
                        Desenvolver e empregar novas tecnologias;
                        Manter e melhorar continuamente nosso sistema de gestão;
    ...
    <div class="container">
        ...
        <div class="row m-b-lg">
            <div class="col-lg-3 col-lg-offset-3">
                <address>
                    <strong><span class="navy">Você Seguro Sempre.</span></strong><br/>
                    R. Alm. Calheiros, 382 - Tatuapé<br/>
                    São Paulo, SP 03066-070<br/>
                    <abbr title="Phone">Tel: </abbr> (11) 4841-2677
                </address>
            </div>
            <div class="col-lg-4">
                <p class="text-color">
        ...
        <div class="row">
            ...
            <div class="col-lg-12 text-center redes">
                ...
                <ul class="list-inline social-icon">
                    <li>
                        <a href="https://www.facebook.com/Voc%C3%AA-Seguro-Sempre-Alarme-Monitorado-202562450346666/?hc_ref=ARToithlf2c62tjInI6ticMVoKz886QUE6X2omfwpA9LUFj_EuVG2GNrNBruZbjL12I&fref=nf" target="_blank">
